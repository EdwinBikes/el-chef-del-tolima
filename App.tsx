...
const menuItems = [
    ...
    { name: "Tamal grande", description: "Nuestra porción más generosa para satisfacer los paladares más exigentes.", price: "$7k", imageUrl: "https://i.postimg.cc/NMzxCDvp/Tu-Historia-Promocional-Hamburguesa-Tradicional-Cafe.png" },
